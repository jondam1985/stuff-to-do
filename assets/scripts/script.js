...
//This function gets the current time and date and renders it in the page
...
//This function format the textareas depending on the time of the day
...
function init() {
    ...
    //This block updates the date and time every second
    var timer = setInterval(getDateTime, 1000);

    //This block updates the format every second
    var fieldFormat = setInterval(formatTextFields, 1000);
